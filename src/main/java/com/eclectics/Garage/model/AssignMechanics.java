...
public class AssignMechanics {
    ...
    public AssignMechanics(Long id, ServiceRequest service, Mechanic mechanic, AssignMechanicStatus status, LocalDateTime assignedAt, LocalDateTime updatedAt) {
        this.id = id;
    ...
    public AssignMechanicStatus getStatus() { return status;}
    public void setStatus(AssignMechanicStatus status) { this.status = status; }
