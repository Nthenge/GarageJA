...
public class AssignMechanicsRequestsDTO {
    ...
    public AssignMechanicsRequestsDTO() {}

    public AssignMechanicsRequestsDTO(ServiceRequest service, Mechanic mechanic, AssignMechanicStatus status, LocalDateTime assignedAt, LocalDateTime updatedAt) {
